...
Usage:
    python scripts/rebroadcast_line.py 00981A 00988A 00997A
    python scripts/rebroadcast_line.py --regen 00981A 00988A 00997A
"""
...
def main() -> int:
    ...
    ap.add_argument("tickers", nargs="+",
                    help="Active ETF tickers to broadcast (e.g. 00981A 00988A 00997A)")
