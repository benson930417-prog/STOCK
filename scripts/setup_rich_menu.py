...
Page 1 bottom: 市場脈動 | 吳大師 | 類股洞察 | 24小時那斯達克 | ▶更多
...
PAGE1 = [
    ...
    # Row 2 — five direct actions; 類股洞察 is a real visible menu tile.
    (0,    843, 500, 843, "脈", "市場脈動", "加權狀態",       ( 99, 102, 241), "message",        "市場脈動", False),
    (500,  843, 500, 843, "師", "吳大師",   "持股總覽",       (180,  83,   9), "message",        "吳大師", False),
    (1000, 843, 500, 843, "洞", "類股洞察", "ETF買賣主線",    (239,  68,  68), "message",        "題材洞察", False),
